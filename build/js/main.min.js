...
/* harmony import */ var _modules_video_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/video.js */ "./js/modules/video.js");
/* harmony import */ var _modules_video_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_video_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_subscriptions_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/subscriptions.js */ "./js/modules/subscriptions.js");
/* harmony import */ var _modules_subscriptions_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_subscriptions_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_navigation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/navigation.js */ "./js/modules/navigation.js");
...
/* harmony import */ var _modules_slider_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_slider_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_carousel_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/carousel.js */ "./js/modules/carousel.js");
/* harmony import */ var _modules_carousel_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_carousel_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/form.js */ "./js/modules/form.js");
/* harmony import */ var _modules_form_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_form_js__WEBPACK_IMPORTED_MODULE_7__);
...
var swiperSection = document.querySelector('.review__wrapper');
var swiperWrapper = document.querySelector('.reviews-list');
var swiperButtons = document.querySelectorAll('.review__carousel-button');
...
var submitButton = document.querySelector('button[data-form-submit]');
var nameError = submitButton.closest('form').querySelector('div[data-error-message="name"]');
var nameInput = submitButton.closest('form').querySelector('input[name="name"]');
var telError = submitButton.closest('form').querySelector('div[data-error-message="tel"]');
var telInput = submitButton.closest('form').querySelector('input[type="tel"]');
...
var hideValidationMessage = function hideValidationMessage(func) {
  setTimeout(function () {
    func();
  }, 2000);
};
var hideContent = function hideContent(element, action) {
...
submitButton.addEventListener('click', function () {
  var telValue = telInput.value.replace(/\D+/g, '');
...
var mainSectionButton = document.querySelector('.main-section__button');
var subscriptionsSection = document.querySelector('.subscriptions__wrapper');
mainSectionButton.addEventListener('click', function () {
...
var swiperWrapper = document.querySelector('.trainers__list');
var swiperSection = document.querySelector('.trainers__wrapper');
var swiperButtons = document.querySelectorAll('.trainers__slider-button');
var breakpointMobile = window.matchMedia('(max-width: 767px)');
var breakpointTablet = window.matchMedia('screen and (min-width: 768px) and (max-width: 1199px)');
var breakpointDesktop = window.matchMedia('screen and (min-width: 1200px)');
var unfocusSlides = function unfocusSlides() {
  var slidesAll = swiperSection.querySelectorAll('.swiper-slide');
  slidesAll.forEach(function (slide) {
    slide.removeAttribute('tabindex');
  });
};
var focusMobileSlides = function focusMobileSlides() {
  unfocusSlides();
  var activeSlide = swiperSection.querySelector('.swiper-slide-active');
  activeSlide.setAttribute('tabindex', 0);
};
var focusTabletSlides = function focusTabletSlides() {
  unfocusSlides();
  var activeSlide = swiperSection.querySelector('.swiper-slide-active');
  var nextSlide = swiperSection.querySelector('.swiper-slide-next');
  activeSlide.setAttribute('tabindex', 0);
  nextSlide.setAttribute('tabindex', 0);
};
var focusDesktopSlides = function focusDesktopSlides() {
  unfocusSlides();
  var activeIndex;
  var slidesAll = swiperSection.querySelectorAll('.swiper-slide');
  slidesAll.forEach(function (slide, i) {
...
var ACTIVE_BUTTON_CLASS = 'tabs-list__button--active';
var tabsList = document.querySelector('.subscriptions__tabs');
var tabsButtons = document.querySelectorAll('.tabs-list__button');
var subscriptionsLists = document.querySelectorAll('.subscriptions__list');
var showActiveList = function showActiveList() {
...
var activeTab = document.querySelector('.' + ACTIVE_BUTTON_CLASS);
...
var video = document.querySelector('.gym-section__video');
var button = video.querySelector('.gym-section__video-button');
